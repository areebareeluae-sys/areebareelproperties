...
INSERT INTO `__new_form_applications`("id", "user_id", "app_no", "date", "full_name", "cnic", "father_name", "dob", "mobile", "alt_contact", "address", "photo_url", "categories", "applicant_income", "household_income", "applicant_income_type", "living_arrangement", "earning_members", "dependents", "participation_amount", "cnic_front_url", "cnic_back_url", "nominee_name", "nominee_relation", "nominee_cnic", "nominee_mobile", "declaration_accepted", "created_at", "status") SELECT "id", "user_id", "app_no", "date", "full_name", "cnic", "father_name", "dob", "mobile", "alt_contact", "address", "photo_url", "categories", "applicant_income", "household_income", "applicant_income_type", "living_arrangement", "earning_members", "dependents", "participation_amount", "cnic_front_url", "cnic_back_url", "nominee_name", "nominee_relation", "nominee_cnic", "nominee_mobile", "declaration_accepted", "created_at", "status" FROM `form_applications`;--> statement-breakpoint
