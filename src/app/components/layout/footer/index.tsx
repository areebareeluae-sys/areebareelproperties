...
const Footer = () => {
  ...
  const phoneNumber = "+923091000070"; // Formatted for WhatsApp API link

  return (
    <footer className="relative z-10 bg-midnight_text dark:bg-semidark">
      {/* Floating WhatsApp Button - Left Side Position */}
      <a
        href={`https://wa.me/${phoneNumber}`}
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Chat on WhatsApp"
        className="fixed bottom-5 left-4 sm:left-6 z-[9999] flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20ba5a] text-white rounded-full shadow-2xl hover:scale-110 transition-all duration-300 ease-in-out"
      >
        <svg
          ...
          <div className="lg:max-w-45 max-w-full text-center lg:text-left mb-4 lg:mb-0">
            <div className="flex lg:flex-nowrap flex-wrap lg:flex-row lg:gap-11 gap-4 text-base sm:text-lg md:text-xl text-black text-opacity-50">
              <p className="text-white">
                Phone :
                <Link href="#" className="text-gray hover:text-white"> +923091000070</Link>
              </p>
              <p className="text-white">
                Email :
